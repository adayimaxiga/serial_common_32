...
void communicate_param_init()
{
	...
	computer_usart.USARTx = UART4;
	
	computer_usart.rx_DMAx = DMA1;
	computer_usart.rx_Stream = LL_DMA_STREAM_2;
	computer_usart.rx_dma_stream=DMA1_Stream2;

	computer_usart.tx_DMAx = DMA1;
	computer_usart.tx_Stream = LL_DMA_STREAM_4;
	computer_usart.tx_dma_stream=DMA1_Stream4;
